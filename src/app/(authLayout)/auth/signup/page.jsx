...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-[#edf2fc] to-white px-4">
      <div className="w-full max-w-xl  bg-white shadow-xl rounded-2xl p-8 lg:p-10">
        {/* HEADER */}
        <div className="text-center mb-8 space-y-3">
          ...
          <p className="text-sm text-gray-500 leading-relaxed max-w-sm mx-auto">
            Join NakshaTiles to save your favorite designs, manage orders, and
            explore premium tile collections for your dream spaces.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1">
            ...
            {errors.photoUrl && (
              <span className="text-xs text-red-500">PhotoUrl is required</span>
            )}
          </div>
